...
export const INITIAL_FAQS: FAQItem[] = [
  ...
  // --- 9. DONATIONS & FINANCIAL TRANSPARENCY ---
  {
    ...
    aEn: 'Yes. Every rupee contributed directly reaches the central trust bank account (Society Reg No. 02/42/01/28332/26). An automated, tamper-proof digital receipt with a unique transaction ID and QR code is instantly emailed and generated for download.',
